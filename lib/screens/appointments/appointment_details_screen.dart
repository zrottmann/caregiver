          ...
          children: [
            ...
            ListTile(
              ...
              onTap: () {
                ...
                // context.push('/caregiver-profile/${appointment.caregiverId}'); // Navigation disabled
                ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(content: Text('Caregiver profile coming soon')),
                );
              },
            ),
          ],
        ...
        if (isPatient) ...[
          SizedBox(
            ...
            child: ElevatedButton.icon(
              onPressed: () {
                // context.push('/chat/${appointment.caregiverId}'); // Navigation disabled
                ScaffoldMessenger.of(context).showSnackBar(
          ...
          SizedBox(
            ...
            child: ElevatedButton.icon(
              onPressed: () {
                // context.push('/chat/${appointment.patientId}'); // Navigation disabled
                ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(content: Text('Chat coming soon')),
                );
              },
